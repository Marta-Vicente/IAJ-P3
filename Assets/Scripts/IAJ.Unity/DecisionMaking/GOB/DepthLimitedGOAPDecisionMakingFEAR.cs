...
{
    public class DepthLimitedGOAPDecisionMakingFEAR
    {
        ...
        private WorldModelFEAR[] Models { get; set; }
        ...
        public DepthLimitedGOAPDecisionMakingFEAR(CurrentStateWorldModel currentStateWorldModel, List<Action> actions, List<Goal> goals)
        {
        ...
        public void InitializeDecisionMakingProcess()
        {
            ...
            this.CurrentDepth = 0;
            this.Models = new WorldModelFEAR[MAX_DEPTH + 1];
            this.Models[0] = new WorldModelFEAR(InitialWorldModel);
